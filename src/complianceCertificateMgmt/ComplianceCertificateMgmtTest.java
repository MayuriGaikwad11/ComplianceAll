...
public class ComplianceCertificateMgmtTest {
	...
	void ComplianceCertificate() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateMgmtMethod.ComplianceCertificate(driver,test);
...
//	@Test(priority = 3)
	void ComplianceCertificateParticularPeriod() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateMgmtMethod.ComplianceCertificateParticularPeriod(driver,test);
	...
	void CertificateParticularPeriodCompliance() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateMgmtMethod.CertificateParticularPeriodCompliance(driver,test);
