...
public class ComplianceCertificateReviewerTest {
	...
	void CustomersCreate() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateReviewerMethod.CertificateReviewer(driver,test);
	...
	void CertificateReviewerParticularPeriod() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateReviewerMethod.CertificateReviewerParticularPeriod(driver,test);
	...
	void ComplianceCertificateReviewerMethod() throws InterruptedException, IOException
	{
		...
		ComplianceCertificateReviewerMethod.CertificateReviewerParticularPeriodCompliance(driver,test);
